...
好的！严格延续你笔记的极简风格：**仅展示效果 + 对应代码块，无解释性文字，用 `---` 分隔**。以下是 **Images（图片）** 章节的续写：
...
![示例图](https://dummyimage.com/400x200/eee/aaa){ align=left }
...
![示例图](https://dummyimage.com/400x200/eee/aaa){ align=right }
...
![示例图](https://dummyimage.com/400x200/){ width="300" }
/// caption
这是图片标题
///
...
![示例图](https://dummyimage.com/600x400/eee/aaa){ loading=lazy }
...
![亮色模式图](https://dummyimage.com/400x200/f5f5f5/aaaaaa#only-light)
![暗色模式图](https://dummyimage.com/400x200/21222c/d5d7e2#only-dark)
